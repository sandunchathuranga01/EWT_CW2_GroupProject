    ...
    $.ajax({
        ...
        success: function (data) {
            if (data.code==="00"){
                ...
                for (let disposalPlace1 of data.content) {
                    let Location_ID = disposalPlace1.locationID
                    let Name = disposalPlace1.name
                    let Address = disposalPlace1.address
                    let Latitude = disposalPlace1.lat
                    let Longitude = disposalPlace1.lng
